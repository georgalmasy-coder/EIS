...
public class IncidentMaintenanceXmlDocument extends GenericXmlDocument {

    private final Document document;
    private final Element rootElement;

    public IncidentMaintenanceXmlDocument(WebSession webSession, String rootElementName) {
        super(webSession);
