...
public class LogicalStructureServlet extends GenericDataProviderServlet {
    ...
    private static LogicalStructureExportRow toExportRow(LogicalStructureEntity entity) {
        return new LogicalStructureExportRow(
                ...
                entity.getOwner(),
                entity.getLogicalVerificationStatus(),
                entity.getLogicalCriticality(),
                entity.getLogicalElementCategory(),
                entity.getLogicalLevel(),
                entity.getLogicalType(),
                entity.getLogicalResponsibleDomain(),
                entity.getLogicalLifecycleStatus(),
                entity.getLogicalMaturity(),
                entity.getLogicalAllocationStatus(),
                entity.getLogicalRealizationStatus(),
                entity.getLogicalSafetyClassification(),
                entity.getLogicalSecurityClassification(),
                entity.getLogicalRedundancyType(),
                entity.getLogicalConfigurationVariant(),
                entity.getLogicalApplicability(),
