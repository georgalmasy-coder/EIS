...
public class SubscriptionEditorXmlDocument extends GenericXmlDocument {

    private final Document document;
    private final Element rootElement;

    public SubscriptionEditorXmlDocument(WebSession webSession, String rootElementName) {
        super(webSession);
