...
public class FunctionalStructureServlet extends GenericDataProviderServlet {
    ...
    private static FunctionalStructureExportRow toExportRow(FunctionalStructureEntity entity) {
        return new FunctionalStructureExportRow(
                ...
                entity.getFunctionCategory(),
                entity.getFunctionCriticality(),
                entity.getFunctionVerificationStatus(),
                entity.getFunctionLevel(),
                entity.getFunctionOperatingMode(),
                entity.getFunctionResponsibleDomain(),
                entity.getFunctionConfigurationVariant(),
                entity.getFunctionApplicability(),
