...
public enum PageType {
    ...
    DASHBOARD_SYSTEMS_TEAMWORK_PAGE("dashboard-systems-teamwork","html-pages/dashboard-systems-teamwork.html", "Physical Interface Teamwork", true, "PROJECT DASHBOARD", "Physical Interface Teamwork", "Monitor the current status and key metrics."),
    ...
    FUNCTIONAL_STRUCTURE_MAIN_PAGE("functionalstructure-main","html-pages/functionalstructure-main.html", "Functional", true, "R-F-L-P MODEL - FUNCTIONAl ARCHITECTURE", "Functional Architecture", "Work with functional architecture in the workspace below."),
    FUNCTIONAL_STRUCTURE_EDIT_PAGE("functionalstructure-edit","html-pages/functionalstructure-edit.html", "Functional Architecture Edit", true, "R-F-L-P MODEL - FUNCTION", "Functional Architecture Edit", "Edit the current functional architecture in the workspace below."),
    FUNCTIONAL_STRUCTURE_MAIN_HORIZONTAL_PAGE("functionalstructure-main-horizontal","html-pages/functionalstructure-main-horizontal.html", "Functional Architecture", true, "R-F-L-P MODEL - FUNCTIONAL ARCHITECTURE", "Functional Architecture", "Work with functional architecture in the workspace below."),
    FUNCTIONAL_STRUCTURE_MAIN_VERTICAL_PAGE("functionalstructure-main-vertical","html-pages/functionalstructure-main-vertical.html", "Functional Architecture", true, "R-F-L-P MODEL - FUNCTIONAL ARCHITECTURE", "Functional Design", "Work with functional architecture in the workspace below."),

    LOGICAL_STRUCTURE_MAIN_PAGE("logicalstructure-main","html-pages/logicalstructure-main.html", "Logical Architecture", true, "R-F-L-P MODEL - LOGICAL ARCHITECTURE", "Logical Architecture", "Work with logical structure in the workspace below."),
    LOGICAL_STRUCTURE_EDIT_PAGE("logicalstructure-edit","html-pages/logicalstructure-edit.html", "Logical Architecture Edit", true, "R-F-L-P MODEL - LOGICAL ARCHITECTURE", "Logical Architecture Edit", "Edit the current logical structure in the workspace below."),
    LOGICAL_STRUCTURE_MAIN_HORIZONTAL_PAGE("logicalstructure-main-horizontal","html-pages/logicalstructure-main-horizontal.html", "Logical Architecture", true, "R-F-L-P MODEL - LOGICAL ARCHITECTURE", "Logical Architecture", "Work with logical structures in the workspace below."),
    LOGICAL_STRUCTURE_MAIN_VERTICAL_PAGE("logicalstructure-main-vertical","html-pages/logicalstructure-main-vertical.html", "Logical Architecture", true, "R-F-L-P MODEL - LOGICAL ARCHITECTURE", "Logical Architecture", "Work with logical architecture in the workspace below."),

    SYSTEMS_BREAKDOWN_MAIN_PAGE("systemsbreakdown-main","html-pages/systemsbreakdown-main.html", "Physical Architecture", true, "R-F-L-P MODEL - PHYSICAL ARCHITECTURE", "Physical Architecture", "Work with physical architecture items in the workspace below."),
    SYSTEMS_BREAKDOWN_EDIT_PAGE("systemsbreakdown-edit","html-pages/systemsbreakdown-edit.html", "Physical Architecture Edit", true, "R-F-L-P MODEL - PHYSICAL ARCHITECTURE", "Physical Architecture Edit", "Edit the current physical architecture item in the workspace below."),
    SYSTEMS_BREAKDOWN_MAIN_HORIZONTAL_PAGE("systemsbreakdown-main-horizontal","html-pages/systemsbreakdown-main-horizontal.html", "Physical Architecture", true, "R-F-L-P MODEL - PHYSICAL STRUCTURES", "Physical Architecture", "Work with physical architecture items in the workspace below."),
    SYSTEMS_BREAKDOWN_MAIN_VERTICAL_PAGE("systemsbreakdown-main-vertical","html-pages/systemsbreakdown-main-vertical.html", "Physical Architecture", true, "R-F-L-P MODEL - PHYSICAL STRUCTURES", "Physical Architecture", "Work with physical architecture items in the workspace below."),
    ...
    PSYS_INTERFACE_MANAGEMENT_PAGE("psys-interfaces","html-pages/psys-interfaces.html", "N2 Physical Architecture", true, "R-F-L-P MODEL - INTERFACE MANAGEMENT", "Interface Management - Physical Architecture", "Manage interfaces and related relationships."),
    LSYS_INTERFACE_MANAGEMENT_PAGE("lsys-interfaces","html-pages/lsys-interfaces.html", "N2 Logical Architecture", true, "R-F-L-P MODEL - INTERFACE MANAGEMENT", "Interface Management - Logical Architecture", "Manage interfaces and related relationships."),
    FSYS_INTERFACE_MANAGEMENT_PAGE("fsys-interfaces","html-pages/fsys-interfaces.html", "N2 Functional Architecture", true, "R-F-L-P MODEL - INTERFACE MANAGEMENT", "Interface Management - Functional Architecture", "Manage interfaces and related relationships."),
