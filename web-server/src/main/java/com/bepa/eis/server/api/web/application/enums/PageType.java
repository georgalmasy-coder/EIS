...
public enum PageType {
    ...
    LOGICAL_STRUCTURE_MAIN_PAGE("logicalstructure-main","html-pages/logicalstructure-main.html", "Logical Structure", true, "R-F-L-P MODEL - STRUCTURES", "Logical Structure", "Work with logical structures in the workspace below."),
    FUNCTIONAL_STRUCTURE_MAIN_PAGE("functionalstructure-main","html-pages/functionalstructure-main.html", "Functional Structure", true, "R-F-L-P MODEL - STRUCTURES", "Functional Structure", "Work with functional structures in the workspace below."),
    ...
    LOGICAL_STRUCTURE_EDIT_PAGE("logicalstructure-edit","html-pages/logicalstructure-edit.html", "Logical Structure Edit", true, "R-F-L-P MODEL - STRUCTURES", "Logical Structure Edit", "Edit the current logical structure in the workspace below."),
    FUNCTIONAL_STRUCTURE_EDIT_PAGE("functionalstructure-edit","html-pages/functionalstructure-edit.html", "Functional Structure Edit", true, "R-F-L-P MODEL - STRUCTURES", "Functional Structure Edit", "Edit the current functional structure in the workspace below."),
    ...
    LOGICAL_STRUCTURE_MAIN_LIST_PAGE("logicalstructure-main-list","html-pages/logicalstructure-main-list.html", "Logical Structure", true, "R-F-L-P MODEL - STRUCTURES", "Logical Structure", "Work with logical structures in the workspace below."),
    LOGICAL_STRUCTURE_MAIN_HORIZONTAL_PAGE("logicalstructure-main-horizontal","html-pages/logicalstructure-main-horizontal.html", "Logical Structure", true, "R-F-L-P MODEL - STRUCTURES", "Logical Structure", "Work with logical structures in the workspace below."),
    LOGICAL_STRUCTURE_MAIN_VERTICAL_PAGE("logicalstructure-main-vertical","html-pages/logicalstructure-main-vertical.html", "Logical Structure", true, "R-F-L-P MODEL - STRUCTURES", "Logical Structure", "Work with logical structures in the workspace below."),
    FUNCTIONAL_STRUCTURE_MAIN_LIST_PAGE("functionalstructure-main-list","html-pages/functionalstructure-main-list.html", "Functional Structure", true, "R-F-L-P MODEL - STRUCTURES", "Functional Structure", "Work with functional structures in the workspace below."),
    FUNCTIONAL_STRUCTURE_MAIN_HORIZONTAL_PAGE("functionalstructure-main-horizontal","html-pages/functionalstructure-main-horizontal.html", "Functional Structure", true, "R-F-L-P MODEL - STRUCTURES", "Functional Structure", "Work with functional structures in the workspace below."),
    FUNCTIONAL_STRUCTURE_MAIN_VERTICAL_PAGE("functionalstructure-main-vertical","html-pages/functionalstructure-main-vertical.html", "Functional Structure", true, "R-F-L-P MODEL - STRUCTURES", "Functional Structure", "Work with functional structures in the workspace below."),
