...
public class LookupValueMaintenanceXmlDocument extends GenericXmlDocument {

    private final Document document;
    private final Element rootElement;

    public LookupValueMaintenanceXmlDocument(WebSession webSession, String rootElementName) {
        super(webSession);
