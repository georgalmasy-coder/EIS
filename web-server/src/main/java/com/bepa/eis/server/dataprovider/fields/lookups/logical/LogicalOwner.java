...
public class LogicalOwner extends AbstractUserLookup {

    private static final Logger log = LoggerFactory.getLogger(LogicalOwner.class);

    public static String FIELD_NAME = "LogicalOwnerId";

    public LogicalOwner() {
        super();
    }

    public LogicalOwner(WebSession webSession) {
        super(webSession);
    }
