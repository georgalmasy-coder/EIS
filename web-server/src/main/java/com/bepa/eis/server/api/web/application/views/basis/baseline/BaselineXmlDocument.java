...
public class BaselineXmlDocument extends GenericXmlDocument {

    private final Document document;
    private final Element rootElement;

    public BaselineXmlDocument(
    ...
    public Element appendTextElement(
            Element parent,
            String elementName,
            Object value
    ) {
        ...
        if (value != null) {
            element.setTextContent(toXmlValue(value));
        }

        return element;
    }

    public Element appendImportedElement(
            Element parent,
