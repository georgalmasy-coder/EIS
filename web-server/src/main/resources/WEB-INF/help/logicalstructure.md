...
Logical structures describe needs, expectations, constraints or requests from stakeholders. These logical structures can later be linked to system requirements and other engineering information.

## What does this page show?

The page shows a table of logical structures.
...
The main table contains the logical structures available for the selected project.
...
Use **Import** to import logical structures from a file.
...
Use **Export** to export logical structures from the current project.
...
The **Basis Info** tab contains the main information about the logical structure.
...
The **History** tab shows previous changes to the logical structure.
...
This can be used to understand when the logical structure was updated and by whom.
...
The **Notes** tab shows notes related to the logical structure.
...
The **Links** tab is reserved for links related to the logical structure.
...
If no logical structures are shown, it may be because:

- data is still loading
- no logical structures exist for the selected project
...
- Use relations to connect logical structures to relevant system requirements.
- Export the list when logical structures need to be reviewed outside the system.
