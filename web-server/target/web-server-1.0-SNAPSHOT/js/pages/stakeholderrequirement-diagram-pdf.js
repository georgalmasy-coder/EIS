...
export function downloadStakeholderRequirementDiagramPdf({
                                                             tree,
                                                             layout,
                                                             orientation,
                                                             topPanel,
...
function buildDiagramPdfFileName(orientation, topPanel) {
    ...
    return `stakeholder-requirement-${orientation}-diagram-${projectName}.pdf`;
}
...
function drawPdfHeader(commands, options) {
    ...
    drawPdfText(
        commands,
        `Stakeholder Requirement ${orientationLabel} Diagram - ${topPanel.projectName || "Project"}`,
        margin,
    ...
    drawPdfText(
        commands,
        `${topPanel.customerName || "Customer"} · Stakeholder requirements: ${requirementCount}`,
        margin,
